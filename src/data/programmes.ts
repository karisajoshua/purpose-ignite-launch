  ...
  },
  {
    ...
    programmes: [
      ...
      },
      {
        ...
        modules: [
          { title: "Generate Your Business Idea (GYB)", topics: [] },
          { title: "Start Your Business (SYB)", topics: [] },
          { title: "Improve Your Business (IYB)", topics: [] },
          { title: "Expand Your Business (EYB)", topics: [] },
          { title: "SIYB Business Game", topics: [] },
          { title: "Digitalize Your Business Module", topics: [] },
        ],
      },
    ],
  },
