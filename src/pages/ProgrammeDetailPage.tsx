...
const ProgrammeDetailPage = () => {
  ...
  const cluster = clusters.find((cluster) =>
    cluster.programmes.some(
      (programmeItem) => programmeItem.slug === slug
    )
  );
          ...
          <div className="border border-border mb-12">
            ...
            <div className="p-8 md:p-10 border-b border-border">
              ...
              <p className="text-muted-foreground text-sm mt-2">
                Explore each module to see the topics covered.
              </p>
            </div>
                  ...
                  >
                    ...
                    {isOpen && (
                      <div
                        ...
                        className="px-6 pb-7 md:px-8 md:pb-8"
                      >
                        <div className="ml-0 md:ml-[52px] pt-1">
